...
Route::post('/events/{id}', [AgentAdminController::class, 'updateevent'])->name('events.update');
...
Route::post('/property/{id}/terjual', [PropertyDetailController::class, 'markAsSold'])
    ->name('listing.terjual');
