    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Ruko Sentra Bisnis Lidah Kulon B-01 Lakarsantri Surabaya</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+62 813-3571-6679</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>SolusindoSurabaya@gmail.com</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link text-white-50" href="{{ url('/terms-conditions') }}">Terms & Condition</a>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Sinergi Solusindo Lelang</a>, All Right Reserved.
